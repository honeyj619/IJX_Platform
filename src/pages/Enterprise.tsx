      ...
      <div className="relative w-full h-64 bg-gradient-to-r from-yellow-400 to-blue-500 flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-center mb-4">
            <h2 className="text-4xl font-bold text-white mb-2">吉刻出发</h2>
            <p className="text-white text-lg">置身想象，皆有可玩</p>
          </div>
          ...
          <div className="w-full max-w-3xl px-6">
            <div className="relative">
              <input
                type="text"
                placeholder="输入内容搜索，或上传的文件"
                className="w-full px-4 py-3 pl-10 pr-16 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
              ...
              <div className="space-y-3">
                <ProcessItemFlow 
                  title="关于开展2025年第二期黄沙活动的预告" 
                  code="编号：TSP-2025-0073" 
                  creator="由李正刚创建" 
                  time="2025-06-10 12:42:33" 
                  location="当前节点：4执行"
                />
                <ProcessItemFlow 
                  title="关于高乐飞机涂装宣传" 
                  code="编号：TSP-2025-0074" 
                  creator="由李正刚创建" 
                  time="2025-06-10 15:11:53" 
                  location="当前节点：4执行"
                />
                <ProcessItemFlow 
                  title="关于航空安保系统的上传固件申请" 
                  code="编号：TSP-2025-0075" 
                  creator="由赵创新创建" 
                  time="2025-06-10 13:36:19" 
                  location="当前节点：4执行"
                />
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
              ...
              <div className="space-y-3">
                <DocumentItem 
                  ...
                  time="2025-06-12 09:25:07"
                />
                <DocumentItem 
                  title="关于发布浦东-伊宁、浦东-喀什新开航线评估结果的通知" 
                  time="2025-06-12 09:20:05"
                />
                <DocumentItem 
                  title="关于做好2025年上半年工作总结和下半年工作计划的通知" 
                  time="2025-06-11 13:10:09"
                />
                <DocumentItem 
                  title="关于发布《上海吉祥航空股份有限公司安全警示教育长效机制（试行）》的通知" 
                  time="2025-06-11 10:12:34"
                />
                <DocumentItem 
                  title="关于发布3.25L飞机重量更改故变更的通知" 
                  time="2025-06-11 09:37:54"
                />
              </div>
            </div>
            ...
            {/* 关注的项目进度 */}
            <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
              <h3 className="font-semibold text-lg text-gray-900 mb-4">关注的项目进度</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
              ...
              <div className="grid grid-cols-7 gap-1 text-center">
                ...
                <div className="text-sm font-medium text-gray-500">一</div>
                <div className="text-sm font-medium text-gray-500">二</div>
                <div className="text-sm font-medium text-gray-500">三</div>
                <div className="text-sm font-medium text-gray-500">四</div>
                <div className="text-sm font-medium text-gray-500">五</div>
                <div className="text-sm font-medium text-gray-500">六</div>
                <div className="text-sm text-gray-400">9</div>
                <div className="text-sm">10</div>
                <div className="text-sm">11</div>
                <div className="text-sm">12</div>
                <div className="text-sm bg-red-100 text-red-600 font-medium">13</div>
                <div className="text-sm bg-red-100 text-red-600 font-medium">14</div>
                <div className="text-sm bg-red-100 text-red-600 font-medium">15</div>
              </div>
              <div className="mt-4">
                <h4 className="font-medium text-gray-900 mb-2">11月13日 行程</h4>
                <div className="space-y-2">
                  <CalendarEvent time="全天" title="全天值班" color="bg-gray-100" />
                  <CalendarEvent time="10:00-11:00" title="项目周会" color="bg-red-100" />
...
function DocumentItem({ title, time }: { title: string; time: string }) {
  return (
    <div className="flex justify-between items-start p-2 hover:bg-gray-50 transition-colors rounded">
...
function CalendarEvent({ time, title, color }: { time: string; title: string; color: string }) {
  return (
    <div className={`flex items-center gap-2 p-2 ${color} rounded`}>
