...
import { Sun, Moon, Palette, Monitor, Bell, Lock, Globe, Database, HelpCircle, Info } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">应用设置</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">管理您的应用偏好和系统配置</p>
        </div>
          ...
          <div className="w-64 flex-shrink-0">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
              {tabs.map((tab) => (
                ...
                >
                  <span className={activeTab === tab.id ? 'text-theme-500' : 'text-gray-400'}>{tab.icon}</span>
